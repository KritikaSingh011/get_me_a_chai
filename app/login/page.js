...
const LoginPage = () => {
    return (
        <div>
            <div className=" m-auto h-148 w-screen justify-center items-center ">
                <div className="m-auto pt-15 md:w-7/12 lg:w-5/12 xl:w-4/12">
                    <div className="rounded-xl bg-white dark:bg-gray-800 shadow-xl">
                        <div className="p-8">
                            <div className="flex flex-col items-center justify-center text-center space-y-2 gap-3">
                                <div className="w-20 ">
                                    <img src="/coffee-break.gif" alt="logo" className="w-full rounded-full" />
                                </div>
                                <h2 className=" text-2xl text-cyan-900 dark:text-white font-bold">Login/Signup to unlock the
                                    GEtMeAChai
                                </h2>
                            </div>
